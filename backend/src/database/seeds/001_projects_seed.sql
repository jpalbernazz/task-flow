...
VALUES
  ('Redesign do Site', 'Modernizar o site institucional com nova identidade visual e melhor experiencia do usuario.', 'em-andamento', CURRENT_DATE + INTERVAL '10 days', 65, 18, 28),
